...
class PolicyConfig: 
    ...
    vision_encoder_pretrained_type : Optional[str] = "siglipSo400" # options: "dinov3", "siglipSo400"

    # lora vision encoder 
    lora_rank_vision_encoder : int = 8
    ...
    # Allowed: "diffusion", "flow_rect" (Rectified Flow), "flow_gauss" (Gaussian-path FM)
    diffusion_objective : Literal["diffusion", "flow_rect", "flow_gauss"] = "diffusion"
